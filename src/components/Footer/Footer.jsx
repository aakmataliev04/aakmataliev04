			...
			<div className='container'>
				<div className='footer__inner'>
					<div className='footer__column'>
						<div className='footer__title'><Link to='#'>Новая Норма</Link></div>
					...
					<div className='footer__column'>
						<div className='footer__title'><Link to='#'>Документы</Link></div>
						<div className='footer__links'>
							...
							<div className='foot er__link'>Условия гарантии</div>
						</div>
					</div>

					<div className='footer__column'>
						<div className='footer__title' ><Link to='/about'>Контакты</Link></div>
